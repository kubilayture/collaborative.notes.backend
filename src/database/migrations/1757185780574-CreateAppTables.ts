...
export class CreateAppTables1757185780574 implements MigrationInterface {
  name = 'CreateAppTables1757185780574';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "message_threads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "participant1Id" text NOT NULL, "participant2Id" text NOT NULL, "lastMessageAt" TIMESTAMP, "lastMessagePreview" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "unique_thread_participants" UNIQUE ("participant1Id", "participant2Id"), CONSTRAINT "PK_257a191f664b9470b5d94f98264" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
